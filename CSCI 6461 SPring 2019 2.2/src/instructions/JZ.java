		...
		// TODO Auto-generated method stub
				...
				//Extract r,x,i, and effective address (EA)
					...
					if(UnitConverter.binaryStringToInteger(register.getGPRj(r)) == 0)  {
						...
						System.out.println("Register Rx = 0, Set PC <- EA = " + effectiveAddress);
					}
					else {
...
String message = "JZ instruction, R: " + r + ", IX: " + ix + ", address: " + address + ", I: " + i ;
return "JZ instruction, R: " + r + ", IX: " + ix + ", address: " + address + ", I: " + i;
