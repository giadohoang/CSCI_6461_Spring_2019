...
public class STX extends Instructions{
	...
	public String printMessage() {
		// TODO Auto-generated method stub
		System.out.println("STX Instruction, r,ix,i,address = " + r + ", ix = " + ix + ", i = "+ i + ", address = " + address);

String message = "STX Instruction, r,ix,i,address = " + r + ", ix = " + ix + ", i = "+ i + ", address = " + address;
return "STX Instruction, r,ix,i,address = " + r + ", ix = " + ix + ", i = "+ i + ", address = " + address;
