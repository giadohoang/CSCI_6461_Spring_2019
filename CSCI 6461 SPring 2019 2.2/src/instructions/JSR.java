...
public class JSR extends Instructions{
	...
	public void execute(String instruction, Registers register, Memory memory) {
		...
		// TODO Auto-generated method stub
				...
				//Extract r,x,i, and effective address (EA)
					...
					register.setR3(UnitConverter.integerTo16BitBinary(pcAddOne));
					System.out.println("Set R3 <- PC+1");
					//pc <- ea
					register.setPC(effectiveAddress);
					System.out.println("Set PC <- EA");
					// ? R0 should contain pointer to arguments
					// ? Argument list should end with –1 (all 1s) value
	...
	public String printMessage() {
		// TODO Auto-generated method stub
		System.out.println("JSR Instruction: r = " + r +", ix = " + ix +", i = " + i + ", address = " + address );

String message = "JSR Instruction: r = " + r +", ix = " + ix +", i = " + i + ", address = " + address ;
return "JSR Instruction: r = " + r +", ix = " + ix +", i = " + i + ", address = " + address;
