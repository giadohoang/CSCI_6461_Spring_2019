...
public class SMR extends Instructions{
	...
	public void execute(String instruction, Registers register, Memory memory) {
		...
		// TODO Auto-generated method stub
				...
				//Extract r,x,i, and effective address (EA)
					...
					System.out.println("Set MAR = " + effectiveAddress);
					//keep content from memory at address stored in MAR
					register.setMBR(memory.getFromMemory(UnitConverter.binaryStringToInteger(register.getMBR())));
					...
					if(!register.isOverFlow(difference) &&  !register.isUnderFlow(difference)) {
						...
						System.out.println("Not Over/ Under flow, SET GPR(" + r +"), value = " + register.getGPRj(r));
					}
					else {
	...
	public String printMessage() {
		// TODO Auto-generated method stub
		System.out.println("SMR instruction");

String message = "SMR instruction";
return "SMR instruction, r,ix,i,address = " + r +", ix = " + ix + ", i = " + i + ", address = "+ address;
